...
<body>
    ...
    <form action="" method="post">
        ...
        <div class="remember">
            ...
            <label for="remember" name="remember" class="remember-label">Remember me</label>
        </div>
        <br><br>
        <!-- Lupa Sandi -->
        <div class="pass">Reset Password?</div>
        <!-- Tombol login -->
        <button type="submit" name="login">Masuk</button>
        <!-- Blum Mempunyai Akun -->
        <div class="sign-up">
            Belum Mempunyai Akun ? <a href="registrasi.php">Buat Akun </a>
        </div>
    </form>
    </div>
    <!-- tutup form -->
